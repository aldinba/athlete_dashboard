-- Add a new table for GPS data points
...
-- Add speed column to workout_gps_points table
ALTER TABLE workout_gps_points ADD COLUMN IF NOT EXISTS speed NUMERIC(8, 2);
...
-- Add has_gps_data column to workouts table
